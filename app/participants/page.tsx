...
export default async function ParticipantsPage({
  ...
  const competitionId = params.competition ? Number(params.competition) : null;
  ...
  return (
    <Shell title="Participants" active="/participants">
      <form className="panel" method="get">
        <div className="row">
          ...
          <div>
            ...
            <select id="competition" name="competition" defaultValue={params.competition ?? ""}>
